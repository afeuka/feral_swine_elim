...
grid_effort <- function(sysbait_det_eff,#output from grid_sysbaittake,by subperiod
                        ...
                        occ_grid_scale,#"counties" or "watersheds"
                        abund_scale#"elim_areas" or "watersheds"
){ 
  ...
  if(abund_scale=="watersheds"){
    ...
    ao <- ao %>% 
      ...
      select(SiteID,Area_Name,Date,method,flight_time_hr,
             effect_area_km,prop_site_impact) %>% 

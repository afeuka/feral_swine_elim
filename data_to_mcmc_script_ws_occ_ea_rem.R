...
if(file.exists(paste0("C:/Users/Abigail.Feuka/OneDrive - USDA/Feral Hogs/Missouri/Model Ready Data/sysbait_10day_season_nlcd_20_",end_fy,"_1000ft_buffer.RData"))){
  load(paste0("C:/Users/Abigail.Feuka/OneDrive - USDA/Feral Hogs/Missouri/Model Ready Data/sysbait_10day_season_nlcd_20_",end_fy,"_1000ft_buffer.RData"))
} else {
  
  ## systematic baiting  ---------------------------
  sys <- grid_sysbait_take(study_site_grid = study_site_grid,
                           start_date="2020-09-01", 
                           end_date=paste0("20",end_fy,"-09-30"),
                           period=period)
  ## removal  ---------------------------
  ...
  save(nlcd_siteid,sysbait_det_eff,rem_eff_ea,
       file=paste0("C:/Users/Abigail.Feuka/OneDrive - USDA/Feral Hogs/Missouri/Model Ready Data/sysbait_10day_season_nlcd_20_",end_fy,"_1000ft_buffer.RData"))
}

max(sysbait_det_eff$subper_start)
max(rem_eff_ea$Date)
hist(rem_eff_ea$effect_area_hrs)
#fit model -------------------
